...
node_list = 'https://pantherapi/rest/int/' + usename_pw +'/node/list/'

#============【2】==================
#这个获取的band包括offline的，需要注意下
#可以获取都某个dns_prefix下面有多少band,(band_id)

edge_info = 'https://pantherapi/rest/int/' + usename_pw + '/get_edge_info/'


#可以知道这个band下面配置了哪些vip，从何得到对应prefix下面有哪些ip
band_vip = 'https://pantherapi/rest/int/' + usename_pw + '/get_band_vip/'
...
service_name = 'https://pantherapi/rest/int/' + usename_pw + '/service/list/'
